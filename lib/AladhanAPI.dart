class AladhanAPI {
  ...
  AladhanAPI({this.code, this.status, this.data});

  AladhanAPI.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
    if (json['data'] != null) {
      data = new List<Data>();
...
class Hijri {
  ...
  Hijri.fromJson(Map<String, dynamic> json) {
    ...
    day = json['day'];
    weekday =
        json['weekday'] != null ? new WeekdayHj.fromJson(json['weekday']) : null;
    month = json['month'] != null ? new MonthHj.fromJson(json['month']) : null;
    year = json['year'];
    designation = json['designation'] != null
        ? new Designation.fromJson(json['designation'])
        : null;
...
class WeekdayHj {
  ...
  WeekdayHj({this.en, this.ar});

  WeekdayHj.fromJson(Map<String, dynamic> json) {
    en = json['en'];
    ar = json['ar'];
  }
...
class MonthHj {
  ...
  MonthHj({this.number, this.en, this.ar});

  MonthHj.fromJson(Map<String, dynamic> json) {
    number = json['number'];
    en = json['en'];
    ar = json['ar'];
  }
